...
namespace RouteRequirementsBL.Interfaces
{
    public interface IRoute
    {
        ...
        (string start, List<(double distance, string location)>) ShowFullRoute(string
        startLocation, string endLocation);
        List<string> ShowLocations();
        (string start, List<(double distance, string location)>) ShowRoute();
        (string start, List<(double distance, string location)>) ShowRoute(string
        startLocation, string endLocation);
